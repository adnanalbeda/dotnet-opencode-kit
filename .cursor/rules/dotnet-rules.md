...
> **Auto-generated** from `rules/dotnet/` directory in dotnet-opencode-kit.
...
- **High-throughput coding model for routine tasks** (formatting, simple refactors, test generation, boilerplate).
- **Strongest reasoning model for complex architecture decisions** and multi-system analysis.
