...
- **Never hardcode package versions from memory.** Model training data contains outdated 8.x/9.x versions. Always verify the latest stable version before adding a package.
